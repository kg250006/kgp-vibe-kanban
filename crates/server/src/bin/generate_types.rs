...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::workspaces::execution::RemoteControlError::decl(),
        server::routes::workspaces::execution::StartRemoteControlRequest::decl(),
        ...
        executors::actions::claude_remote_control::ClaudeRemoteControlRequest::decl(),
        executors::actions::claude_remote_control::ClaudeRemoteControlPermissionMode::decl(),
        executors::actions::claude_remote_control::ClaudeRemoteControlSpawnMode::decl(),
